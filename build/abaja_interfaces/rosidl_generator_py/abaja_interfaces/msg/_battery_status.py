    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'abaja_interfaces.msg.BatteryStatus')
            logger.debug(
...
class BatteryStatus(metaclass=Metaclass_BatteryStatus):
    ...
    def __init__(self, **kwargs):
        ...
        self.low_voltage_warning = kwargs.get('low_voltage_warning', bool())
    ...
    def __eq__(self, other):
        ...
        if self.percentage != other.percentage:
            return False
        if self.low_voltage_warning != other.low_voltage_warning:
            return False
        return True
    ...
    def low_voltage_warning(self):
        """Message field 'low_voltage_warning'."""
        return self._low_voltage_warning

    @low_voltage_warning.setter
    def low_voltage_warning(self, value):
        if self._check_fields:
            assert \
                isinstance(value, bool), \
                "The 'low_voltage_warning' field must be of type 'bool'"
        self._low_voltage_warning = value
