...
bool abaja_interfaces__msg__battery_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("abaja_interfaces.msg._battery_status.BatteryStatus", full_classname_dest, 50) == 0);
  }
  abaja_interfaces__msg__BatteryStatus * ros_message = _ros_message;
  {  // voltage
  ...
  {  // low_voltage_warning
    PyObject * field = PyObject_GetAttrString(_pymsg, "low_voltage_warning");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->low_voltage_warning = (Py_True == field);
    Py_DECREF(field);
  }
...
PyObject * abaja_interfaces__msg__battery_status__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("abaja_interfaces.msg._battery_status");
  ...
  {  // low_voltage_warning
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->low_voltage_warning ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "low_voltage_warning", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
