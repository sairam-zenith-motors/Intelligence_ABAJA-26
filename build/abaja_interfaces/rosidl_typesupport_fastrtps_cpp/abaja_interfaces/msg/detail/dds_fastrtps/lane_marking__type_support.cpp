...
#include "abaja_interfaces/msg/detail/lane_marking__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const abaja_interfaces::msg::LaneMarking & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  abaja_interfaces::msg::LaneMarking & ros_message)
{
  // Member: left_lane_detected
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = abaja_interfaces::msg::LaneMarking;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_abaja_interfaces
max_serialized_size_key_LaneMarking(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const abaja_interfaces::msg::LaneMarking *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<abaja_interfaces::msg::LaneMarking *>(
    untyped_ros_message);
...
{
  return &abaja_interfaces::msg::typesupport_fastrtps_cpp::_LaneMarking__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, abaja_interfaces, msg, LaneMarking)() {
  return &abaja_interfaces::msg::typesupport_fastrtps_cpp::_LaneMarking__handle;
}
