...
#include "abaja_interfaces/msg/detail/object_distance__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const abaja_interfaces::msg::ObjectDistance & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  abaja_interfaces::msg::ObjectDistance & ros_message)
{
  // Member: class_name
  cdr >> ros_message.class_name;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = abaja_interfaces::msg::ObjectDistance;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const abaja_interfaces::msg::ObjectDistance *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<abaja_interfaces::msg::ObjectDistance *>(
    untyped_ros_message);
...
{
  return &abaja_interfaces::msg::typesupport_fastrtps_cpp::_ObjectDistance__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, abaja_interfaces, msg, ObjectDistance)() {
  return &abaja_interfaces::msg::typesupport_fastrtps_cpp::_ObjectDistance__handle;
}
