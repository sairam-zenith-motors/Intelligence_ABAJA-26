...
#include "abaja_interfaces/msg/detail/wheel_speed__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = abaja_interfaces::msg::WheelSpeed;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const abaja_interfaces::msg::WheelSpeed *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<abaja_interfaces::msg::WheelSpeed *>(
    untyped_ros_message);
...
{
  return &abaja_interfaces::msg::typesupport_fastrtps_cpp::_WheelSpeed__handle;
}
