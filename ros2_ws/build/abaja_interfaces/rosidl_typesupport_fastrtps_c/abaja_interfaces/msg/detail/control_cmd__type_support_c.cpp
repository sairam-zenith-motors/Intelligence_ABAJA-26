...
#include "abaja_interfaces/msg/detail/control_cmd__rosidl_typesupport_fastrtps_c.h"
...
using _ControlCmd__ros_msg_type = abaja_interfaces__msg__ControlCmd;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_abaja_interfaces
bool cdr_serialize_abaja_interfaces__msg__ControlCmd(
  const abaja_interfaces__msg__ControlCmd * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_abaja_interfaces
bool cdr_deserialize_abaja_interfaces__msg__ControlCmd(
  eprosima::fastcdr::Cdr & cdr,
  abaja_interfaces__msg__ControlCmd * ros_message)
{
  // Field name: target_speed_mps
  {
    cdr >> ros_message->target_speed_mps;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_abaja_interfaces
size_t get_serialized_size_abaja_interfaces__msg__ControlCmd(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_abaja_interfaces
size_t max_serialized_size_abaja_interfaces__msg__ControlCmd(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = abaja_interfaces__msg__ControlCmd;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_abaja_interfaces
bool cdr_serialize_key_abaja_interfaces__msg__ControlCmd(
  const abaja_interfaces__msg__ControlCmd * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: target_speed_mps
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_abaja_interfaces
size_t get_serialized_size_key_abaja_interfaces__msg__ControlCmd(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ControlCmd__ros_msg_type * ros_message = static_cast<const _ControlCmd__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_abaja_interfaces
size_t max_serialized_size_key_abaja_interfaces__msg__ControlCmd(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const abaja_interfaces__msg__ControlCmd * ros_message = static_cast<const abaja_interfaces__msg__ControlCmd *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_abaja_interfaces__msg__ControlCmd(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  abaja_interfaces__msg__ControlCmd * ros_message = static_cast<abaja_interfaces__msg__ControlCmd *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_abaja_interfaces__msg__ControlCmd(cdr, ros_message);
}

static uint32_t _ControlCmd__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_abaja_interfaces__msg__ControlCmd(
...
static size_t _ControlCmd__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_abaja_interfaces__msg__ControlCmd(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, abaja_interfaces, msg, ControlCmd)() {
