...
#include "abaja_interfaces/msg/detail/detected_object__rosidl_typesupport_fastrtps_c.h"
...
using _DetectedObject__ros_msg_type = abaja_interfaces__msg__DetectedObject;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = abaja_interfaces__msg__DetectedObject;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const abaja_interfaces__msg__DetectedObject * ros_message = static_cast<const abaja_interfaces__msg__DetectedObject *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_abaja_interfaces__msg__DetectedObject(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  abaja_interfaces__msg__DetectedObject * ros_message = static_cast<abaja_interfaces__msg__DetectedObject *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_abaja_interfaces__msg__DetectedObject(cdr, ros_message);
}

static uint32_t _DetectedObject__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_abaja_interfaces__msg__DetectedObject(
...
static size_t _DetectedObject__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_abaja_interfaces__msg__DetectedObject(
