...
#include "abaja_interfaces/msg/detail/object_distance__rosidl_typesupport_fastrtps_c.h"
...
using _ObjectDistance__ros_msg_type = abaja_interfaces__msg__ObjectDistance;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = abaja_interfaces__msg__ObjectDistance;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const abaja_interfaces__msg__ObjectDistance * ros_message = static_cast<const abaja_interfaces__msg__ObjectDistance *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_abaja_interfaces__msg__ObjectDistance(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  abaja_interfaces__msg__ObjectDistance * ros_message = static_cast<abaja_interfaces__msg__ObjectDistance *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_abaja_interfaces__msg__ObjectDistance(cdr, ros_message);
}

static uint32_t _ObjectDistance__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_abaja_interfaces__msg__ObjectDistance(
...
static size_t _ObjectDistance__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_abaja_interfaces__msg__ObjectDistance(
