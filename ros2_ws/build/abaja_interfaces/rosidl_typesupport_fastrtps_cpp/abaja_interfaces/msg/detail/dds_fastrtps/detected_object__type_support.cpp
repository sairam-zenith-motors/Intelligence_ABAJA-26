...
#include "abaja_interfaces/msg/detail/detected_object__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const abaja_interfaces::msg::DetectedObject & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  abaja_interfaces::msg::DetectedObject & ros_message)
{
  // Member: class_name
  cdr >> ros_message.class_name;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = abaja_interfaces::msg::DetectedObject;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const abaja_interfaces::msg::DetectedObject *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<abaja_interfaces::msg::DetectedObject *>(
    untyped_ros_message);
...
{
  return &abaja_interfaces::msg::typesupport_fastrtps_cpp::_DetectedObject__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, abaja_interfaces, msg, DetectedObject)() {
  return &abaja_interfaces::msg::typesupport_fastrtps_cpp::_DetectedObject__handle;
}
