...
{
  new (message_memory) abaja_interfaces::msg::ControlCmd(_init);
}

void ControlCmd_fini_function(void * message_memory)
{
  auto typed_message = static_cast<abaja_interfaces::msg::ControlCmd *>(message_memory);
  typed_message->~ControlCmd();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember ControlCmd_message_member_array[6] = {
  {
    ...
    offsetof(abaja_interfaces::msg::ControlCmd, target_speed_mps),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(abaja_interfaces::msg::ControlCmd, steering_angle_deg),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(abaja_interfaces::msg::ControlCmd, throttle_percent),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(abaja_interfaces::msg::ControlCmd, brake_percent),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(abaja_interfaces::msg::ControlCmd, emergency_stop),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(abaja_interfaces::msg::ControlCmd, source),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ControlCmd_message_members = {
  ...
  6,  // number of fields
  sizeof(abaja_interfaces::msg::ControlCmd),
...
{
  return &::abaja_interfaces::msg::rosidl_typesupport_introspection_cpp::ControlCmd_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, abaja_interfaces, msg, ControlCmd)() {
  return &::abaja_interfaces::msg::rosidl_typesupport_introspection_cpp::ControlCmd_message_type_support_handle;
}
